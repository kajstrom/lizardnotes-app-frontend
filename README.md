...
The APK is signed with Flutter's shared debug key. It is fine for personal sideloading but cannot be published to Google Play, and a future release-signed build will not upgrade it in place.
