...
/// viewport. Returns the chosen [FolderMenuAction] or null if dismissed.
Future<FolderMenuAction?> showFolderContextMenu({
  ...
  final completer = Completer<FolderMenuAction?>();
  OverlayEntry? entry;

  void close([FolderMenuAction? action]) {
...
class _ContextMenuOverlay extends StatelessWidget {
  ...
  final void Function([FolderMenuAction?]) onClose;
  ...
  Widget build(BuildContext context) {
    return CallbackShortcuts(
      ...
      child: Focus(
        ...
        child: Stack(
          children: [
            // Transparent barrier — dismiss on outside tap.
            Positioned.fill(
        ...
        child: Column(
          ...
          children: [
            _MenuItem(
              ...
              onTap: () => onClose(FolderMenuAction.rename),
            ),
            _MenuItem(
              label: 'New subfolder',
              icon: Icons.create_new_folder_outlined,
              onTap: () => onClose(FolderMenuAction.newSubfolder),
            ),
            _MenuItem(
              label: 'New note here',
              icon: Icons.note_add_outlined,
              onTap: () => onClose(FolderMenuAction.newNote),
            ),
            _MenuItem(
              label: 'Move to\u2026',
              icon: Icons.drive_file_move_outlined,
              onTap: () => onClose(FolderMenuAction.moveTo),
            ),
            Container(
            ...
            _MenuItem(
              ...
              isDanger: true,
              onTap: () => onClose(FolderMenuAction.delete),
            ),
          ],
        ),
      ),
